...
struct RadioButtonStyle {
    ...
    int circleRadius = 15;                        ///< Radius of the outer circle in pixels.
    int circlePadding = 12;                        ///< Horizontal space between the circle and the label.
    int innerCirclePadding = 6;                   ///< Padding between the outer circle edge and the inner selected fill.
};
