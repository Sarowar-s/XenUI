...
void setupButtons() {
    ...
    buttons.emplace_back(
        "Button 2",                                                                    // text
        XenUI::PositionParams::Anchored(XenUI::Anchor::TOP_LEFT, 260, 200),              // Position
        style1,                                                                        // style
        []() {
            FPS++;
...
void myinput() {
    ...
    Inputs.emplace_back(
        XenUI::PositionParams::Anchored(XenUI::Anchor::TOP_LEFT, 50, 290),
        "Edit Me!",
        300,         // width
        40,          // fontSize
...
void setupRadioButtons() {
   ...
   channelGroup = std::make_unique<RadioButtonGroup>(&selectedChannel, [](int newValue) {
    ...
    channelGroup->addButton(
        "Option A",
        0, // Value
        XenUI::PositionParams::Anchored(XenUI::Anchor::TOP_LEFT, 50, 390), // Position of first button
    ...
    channelGroup->addButton(
        "Option B",
        1, // Value
        XenUI::PositionParams::Anchored(XenUI::Anchor::TOP_LEFT, 50, 420), // Position of second button
        retainedRadioStyle, // Pass the style
        30 // Font size
    );
    ...
    channelGroup->addButton(
        "Option C",
        2, // Value
        XenUI::PositionParams::Anchored(XenUI::Anchor::TOP_LEFT, 50, 450), // Position of third button
        retainedRadioStyle, // Pass the style
        30 // Font size
    );
}
...
void setupSliders() {
    ...
    sliders.emplace_back(
        ...
        XenUI::PositionParams::Anchored(XenUI::Anchor::TOP_LEFT, 470, 340), 
        160.0f, // Length: 150 pixels wide
    ...
    brightnessSliderStyle.trackThickness = 10;
    brightnessSliderStyle.thumbSize = 25;
    brightnessSliderStyle.valueTextFontSize = 18;

    sliders.emplace_back(
        "retainedBrightnessSlider", // Unique ID
        XenUI::Orientation::VERTICAL,
        XenUI::PositionParams::Anchored(XenUI::Anchor::TOP_LEFT, 455, 400), 
        160.0f, // Length: 180 pixels tall
...
void setupDropdowns() {
    ...
    themeDropdownStyle.mainButtonFontSize = 25;
    themeDropdownStyle.listItemFontSize = 22;
    themeDropdownStyle.paddingX = 20;
    themeDropdownStyle.paddingY = 15;

    dropdowns.emplace_back(
        "themeSelector", // Unique ID
        XenUI::PositionParams::Anchored(XenUI::Anchor::TOP_LEFT, 50, 650),
...
if (XenUI::SwitchImmediate(
    ...
    renderer,
    "Images/Image.png", // path to the image
    XenUI::PositionParams::Anchored(XenUI::Anchor::CENTER_RIGHT, -70, 120),
    0,0, {0,0}, 120, 120
...
XenUI::PositionParams p = XenUI::PositionParams::Anchored(XenUI::Anchor::BOTTOM_CENTER, 0, -100, 300, 300);
//----------------------X-----Y----W----H---
SDL_FRect   view    = { 500, 50, 500, 600 };
SDL_FPoint content = { 0, 800 };
...
, // path to the image
    ...
    110.0f, // desired width
    110.0f // desired height
);
...
extern "C" int SDL_main(int argc, char** argv) {
    // // Uncomment to : run the app in background (when screen is off or using another app)
