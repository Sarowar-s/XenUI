...
struct DropdownStyle {
    ...
    int mainButtonFontSize             = 30;                     ///< Font size for the text in the main button.
    int listItemFontSize               = 28;                     ///< Font size for list item text.
...
const int DEFAULT_DROPDOWN_FONT_SIZE = 30;
