 ...
 *  Parameters determining the checkbox's position relative to its parent/container.
 * The initial checked state (true for checked, false for unchecked).
 * parameters for the checkbox (colors, sizes, etc.).
 *  Font size for the label. If 0 or negative, uses DEFAULT_CHECKBOX_FONT_SIZE.
 *  A function to call when the checkbox state is toggled.
 */
 ...
 *
 *  The SDL_Renderer context to draw upon.
 *  The absolute screen coordinates and dimensions of the checkbox box.
 */
 ...
 *
 *  The SDL_Renderer context.
 *  The coordinate space offset (e.g., from a scroll view) to apply.
 */
 ...
 *
 *  The width of the parent container/content area (default 0).
 *  The height of the parent container/content area (default 0).
 */
...
namespace XenUI {
     ...
     *
     *  A unique string identifier for the checkbox instance.
     *  The text displayed next to the checkbox.
     *  Pointer to the boolean variable holding the check state.
     *  Parameters for positioning the control relative to its parent/content.
     *  Visual style parameters.
     *  Font size for the label.
     *  The coordinate space offset (e.g., scroll position) to apply.
     *  The width of the parent container/content area.
     *  The height of the parent container/content area.
