...
Once you build it on your own, I suggest to install it somewhere easily accessible in your machine, like ``export_path=/c/dev/xenon/install``
and then use this same path when building the project also.
