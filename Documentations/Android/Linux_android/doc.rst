...
*You can mention your ndk, sdk, jdk paths in the build.sh bash file. The first 150 lines are for path setup and checkup. So check them or modify them as needed.*
...
You also need to build the sdk using jdk. 
