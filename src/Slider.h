...
struct SliderStyle {
    ...
    int trackThickness = 8;                       ///< Thickness of the track in pixels.
    int thumbSize = 20;                           ///< Size (width/height) of the square thumb in pixels.
    int padding = 5;                              ///< Padding around the track ends within the slider bounds.
    bool drawValueText = true;                    ///< Flag to enable/disable drawing the current value as text.
    int valueTextFontSize = 14;                   ///< Font size for the value text.
};

const int DEFAULT_SLIDER_FONT_SIZE = 14;
