...
namespace XenUI {
    ...
    struct PagerStyle {
        ...
        SDL_Color tabSelectedTextColor = {255, 255, 255, 255};
        ...
        XenUI::PositionParams tabBarPosition = XenUI::PositionParams::Anchored(XenUI::Anchor::TOP_LEFT, 0, 0);
    };
    ...
    public:
        ...
        bool handleEvent(const SDL_Event& e, SDL_Window* window, const SDL_FPoint& viewOffset) override;
        ...
        ScrollView* getPageScrollView(size_t index) {
            if (index < m_pages.size()) return m_pages[index].scrollView.get();
            return nullptr;
        }
    ...
    private:
        ...
        SDL_FRect m_bounds{};
        SDL_FRect m_contentBounds{};
        SDL_FRect m_tabBarBounds{}; // Added to track tab bar screen area
